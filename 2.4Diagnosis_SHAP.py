...
try:
    ...
    raise ImportError("install SHAP：pip install shap 或 conda install -c conda-forge shap") from e
...
if __name__ == "__main__":
    ...
    # %%
    significant_C0_vs_C1 = pd.read_csv('/home/zhangwenxiang/workspace/python/UKB/OS/v12/limma_DE/pairwise/full_C0_vs_C1.csv')
